...
require (
	...
	github.com/safetorun/PromptDefender/huggingface_jailbreak_model v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/safetorun/PromptDefender/huggingface_jailbreak_model => ../../internal/huggingface_jailbreak_model
